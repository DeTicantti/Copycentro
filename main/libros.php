        ...
        <?php
                        ...
                        if ($res->num_rows>0) {
                            ...
                            <tr>
                                ...
                                <td>
                                    <iframe src="db/lib/<?php echo $archivo;?>" class="rounded" alt="" loading="eager"></iframe>
                                </td> 
                                <td>
...
<div class="btn-add">
        <a href="db/lib/insertar.php"><i class="fas fa-plus-circle"></i></a>
    </div>

    <script>
const head = document.querySelector('.lisLib');
