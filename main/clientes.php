                        ...
                        while ($res->fetch()) { ?>
                            ...
                            <tr>
                                ...
                                <div class="sucessmn ns">
                                    <a href="db/cli/modificar.php?id= <?php echo $clienteid ;?>&nom=<?php echo $clientenom?>&pref=<?php echo $clientepre?>"><i class="fas fa-retweet"></i></a>
                                </div>
                                <div class="errormn ns">
                                    <a href="db/cli/eliminar.php?id= <?php echo $clienteid;?>"><i class="fas fa-trash-alt"></i></a>
                                </div>
